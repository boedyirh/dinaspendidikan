  ...
  <body style="">
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
         <span class="navbar-brand"><strong style="font-family: verdana;"><span class="glyphicon glyphicon-user"></span> Disdik</strong></span>
        ...
        <div class="navbar-collapse collapse" id="navbar-main">
          <ul class="nav navbar-nav">	
            ...
            <li class="dropdown">
				...
				<li><a tabindex="-1" href="<?php echo base_url(); ?>admin/daftar_sekolah">Daftar Sekolah (30 %)</a></li>
        	<li><a tabindex="-1" href="<?php echo base_url(); ?>admin/import_npsn">Import Sekolah</a></li>
      
          <li><a tabindex="-1" href="<?php echo base_url(); ?>admin/daftar_siswa">Daftar Siswa (0 %)</a></li>
		    <li><a tabindex="-1" href="<?php echo base_url(); ?>admin/ref_guru">Daftar Guru/Pengajar (0 %)</a></li>
		    <li><a tabindex="-1" href="<?php echo base_url(); ?>admin/ref_nonguru">Daftar Tenaga Non-Kependidikan (0 %)</a></li>
				</ul>
            </li>
		<?php
		...
		?>	
           <li class="dropdown">
              <a class="dropdown-toggle" data-toggle="dropdown" href="#" id="themes"><i class="icon-random icon-white"> </i> Pemrosesan Data <span class="caret"></span></a>
              <ul class="dropdown-menu" aria-labelledby="themes">
                  <li><a tabindex="-1" href="<?php echo base_url(); ?>admin/import_excel">Import Data Siswa (90 %)</a></li>
                  <li><a tabindex="-1" href="<?php echo base_url(); ?>admin/daftar_upload">Monitoring Upload (90 %)</a></li>
		              <li><a tabindex="-1" href="<?php echo base_url(); ?>admin/ref_sekolah">Monitoring Upload Sekolah (30 %)</a></li>
    ...
    <div class="container">
	  ...
	  <div class="span12 well well-sm">
		<h4 style="font-weight: bold">Dashboard Dinas Pendidikan</a></a></h4>
